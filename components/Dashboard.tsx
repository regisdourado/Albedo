                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="relative z-20 flex flex-col items-center gap-1 group">
                            {/* Text Label */}
                            <div className={`text-[10px] font-bold text-white whitespace-nowrap bg-slate-900/60 backdrop-blur px-2 py-0.5 rounded border border-slate-700/50 shadow-sm mb-1 transition-all duration-300 ${
                                hoveredRegion === region.id || selectedRegion?.id === region.id ? '-translate-y-2 text-orange-300 border-orange-500/50' : ''
                            }`}>
                                {region.name}
                            </div>
                           ...
                           <div className="flex-1 p-6 space-y-6 overflow-y-auto">
                              ...
                              <div className="space-y-2">
                                 ...
                                 <div className={`p-4 rounded-xl border flex items-center gap-3 ${
                                    selectedRegion.riskLevel === 'Crítico' ? 'bg-red-500/10 border-red-500/30 text-red-200' :
                    ...
                    <div className="space-y-1">
                      {[
                        ...
                        <button
                          ...
                          className={`w-full flex items-center justify-between px-3 py-2 rounded transition-all text-sm border border-transparent group ${
                            selectedRiskFilter === risk.label 
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {isLoading ? (
               ...
               <>
                <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-red-500/50 transition-colors animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100 fill-mode-forwards">
                  <div className="flex justify-between items-start">
                    <div>
                ...
                <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-orange-500/50 transition-colors animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 fill-mode-forwards">
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="text-slate-400 text-sm mb-1">Áreas Críticas</p>
                  ...
                  <p className="mt-4 text-xs text-slate-500">Prioridade de Intervenção</p>
                </div>
                
                <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 fill-mode-forwards">
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="text-slate-400 text-sm mb-1">Correlação NDVI/LST</p>
                      <h3 className="text-3xl font-bold text-blue-400">-0.85</h3>
                    </div>
                    <div className="bg-blue-500/10 p-2 rounded-lg text-blue-400">
                      <BarChart3 size={20} />
                    </div>
                  </div>
                  <p className="mt-4 text-xs text-slate-500">Forte correlação negativa</p>
                </div>

                <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500 fill-mode-forwards">
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="text-slate-400 text-sm mb-1">Fonte Dados</p>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="h-80 w-full">
               {isLoading ? (
                  ...
                  <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 h-full animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300 fill-mode-forwards">
            ...
            <div className="h-80 w-full">
               {isLoading ? (
                  ...
                  <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 h-full animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-500 fill-mode-forwards">
